...
$.ajax({
    ...
    data: {
        key: 'OB3BZ-K233W-DLURQ-YOCZR-HU6AO-AMFQD',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    try {
        ...
        document.getElementById("welcome-info").innerHTML =
            `<b><center>🎉 欢迎 🎉</center>&emsp;&emsp;欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴，${timeChange}您现在距离站长约 <span style="color:var(--theme-color)">${dist}</span> 公里， ${posdesc}</b>`;
    } catch (err) {
